...
public class ViewStudentDetails extends javax.swing.JFrame {
    ...
    public void mouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if (row >= 0) {
           ...
           String discount=model.getValueAt(row,7).toString();
...
//                  }
                if(fdt!=null)
                    fdt.dispose();
               fdt=new FeeDetailsTable(list,remark,discount);
            fdt.setVisible(true);
    ...
    public ViewStudentDetails(EmployeeDetails ed){
        this();
        this.ed=ed;
...
//               studentSem.setText(sd.getStudentSem());
            ...
            Object[] rows=new Object[8];                                                                                                                                      // 7 indicates the number of columns of table.
                ...
                rows[3]=st.getLeftFee();
                try{
                if(OldBatchDetector.isOld(st.getBatchStartingDate(), d))
                    rows[5]="OLD";
                else
                    rows[5]="NEW";
                if(RegistrationDao.isRegisteredInVideos(contactNo, st.getBatchId()))
                    rows[4]="Video";
                else
                    rows[4]="Regular Batch";
                }
...
class CustomRenderer1 extends DefaultTableCellRenderer
{
    @Override
