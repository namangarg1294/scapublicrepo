 ...
 * @author Comp10
 */
public class EnrollNewStudent extends javax.swing.JFrame {
    private final EnrollNewStudent ens = this;
    /**
...
//        String start=sdf.format(awtStartDate.getDate());
    ...
    EnrollNewStudent(EmployeeDetails ed) {
       this();
       this.ed=ed;
    ...
    private void initComponents() {
        ...
        takeFee = new javax.swing.JCheckBox();
        isVideo = new javax.swing.JCheckBox();
        ...
        takeFee.setText("Take Fee Also");
        takeFee.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                takeFeeActionPerformed(evt);
            }
        });

        isVideo.setText("Register for Video");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(takeFee)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(isVideo)
                .addGap(54, 54, 54))
        );
    ...
    private void studentIdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_studentIdKeyPressed
        if (evt.getKeyCode()==KeyEvent.VK_ENTER){
         ...
         if(evt.getKeyCode()==KeyEvent.VK_ENTER){
          try {
               dialog.setLocationRelativeTo(EnrollNewStudent.this);
...
startSet();        // TODO add your handling code here:
    ...
    private void takeFeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_takeFeeActionPerformed
        // TODO add your handling code here:
        if(takeFee.isSelected())
            Amount.setEnabled(true);
        else{
            Amount.setText(100+"");
             Amount.setEnabled(false);
        }
    }//GEN-LAST:event_takeFeeActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnrollNewStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new EnrollNewStudent().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JCheckBox isVideo;
    ...
    private javax.swing.JCheckBox takeFee;
...
public void startSet(){
     sd=null;
        ...
        batches.hidePopup();
        takeFee.setSelected(false);
        isVideo.setSelected(false);
        Amount.setText("100");
        Amount.setEnabled(false);
          this.setEnabled(true);
               dialog.dispose();
...
//                    }
            ...
            try {
                System.out.println("Centre is"+ed.getCentre_id());
               ...
               // RegistrationDao.registerStudentInBatch(st.getStudentId(), st.getBatchId());
                ...
                if(isVideo.isSelected())
                    video=1;
                RegistrationDao.registerStudentInBatch(st,video);//using batch update
               // new GSTReceiptPrinter().printGstReciept(st,sd.getStudentName());
