...
public class ViewAttendance extends javax.swing.JFrame {
    private final ViewAttendance ens = this;
...
//        String start=sdf.format(awtStartDate.getDate());
    ...
    ViewAttendance(EmployeeDetails ed) {
       this();
       this.ed=ed;
       ...
       EmployeeId=ed.getEmp_id();
        ...
        try {
         ...
         batches.requestFocus();
          this.model = (DefaultTableModel)jTableAttendance.getModel();
    }
    ...
    private void initComponents() {
        ...
        attendPer = new javax.swing.JTextField();
        ...
        setTitle("View attendace - SCAOnCloud v1.0.0");
        setResizable(false);
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Attendance Details"));
        ...
        jLabel12.setText("Attendace Percentage");

        attendPer.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        attendPer.setEnabled(false);

        jLabel13.setText("Total classes attended");

        attended.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        attended.setEnabled(false);

        jLabel14.setText("Total classes held");

        totalClass.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        totalClass.setEnabled(false);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(attendPer, javax.swing.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(attendPer, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(9, 9, 9)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel13)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, 406, Short.MAX_VALUE))
        );
...
//        new MainFrame().setVisible(true);
    ...
    private void batchesItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_batchesItemStateChanged
        try {
            ...
            int i=AttendanceDao.getClassHeld(batches.getSelectedItem().toString());
             
            totalClass.setText(i+"");
...
startSet();        // TODO add your handling code here:
    ...
    private javax.swing.JTextField attendPer;
...
public void doTask(){
          ...
          if(!RegistrationDao.isRegistered(studentId.getText().substring(0,10), batches.getSelectedItem().toString()))
                 {
                      ...
                      JOptionPane.showMessageDialog(null,"Student is not registered in this batch");
                     studentId.setText("");
                      studentId.setEnabled(true);
                      studentId.requestFocus();
                      attended.setText("");
         ...
         ArrayList<String> list= AttendanceDao.getStudentAttendanceBatchWise(studentId.getText().substring(0,10), batches.getSelectedItem().toString());
                  System.out.println(list);
                  attended.setText(list.size()+"");
                  attendPer.setText(((double)list.size()/Integer.parseInt(totalClass.getText()))*100+"%");
         for(String s:list){
            Object[] rows=new Object[2];                                                                                                                                      // 7 indicates the number of columns of table.
