 ...
 * @author Comp10
 */
public class AddRemark extends javax.swing.JFrame {
    ...
    public void mouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if (row >= 0) {
           ...
           String addedRemark=model.getValueAt(row, 3).toString();
           String discount=model.getValueAt(row, 4).toString();
            System.out.println(batch);
           String studentId=studentContact.getText();
           int registartionId=-1;
            try {
                registartionId=RegistrationDao.getRegistrationId(studentId, batch);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null,"Something went wrong!!");
            }
            String remark=null;
            try {
            remark = JOptionPane.showInputDialog("Please Type Remark for "+batch, addedRemark);
            do {
                discount = JOptionPane.showInputDialog("Enter Discount ",discount);
                if (!discount.matches("^[0-9]*$")) {
                  JOptionPane.showMessageDialog(null,"Enter valid number");
                }
            } while (!discount.matches("^[0-9]*$"));
                System.out.println(discount);
            model.setValueAt(remark,row, 3);
            model.setValueAt(discount,row, 4);
            RegistrationDao.mapRegistrationAndRemark(registartionId, remark,Integer.parseInt(discount));
            JOptionPane.showMessageDialog(null,"Remark Added");
               ...
               try {
                   ...
                   RegistrationDao.updateRemark(registartionId, remark,Integer.parseInt(discount));
                    JOptionPane.showMessageDialog(null,"Remark Updated");
    ...
    public AddRemark(EmployeeDetails ed){
        this();
        this.ed=ed;
    ...
    private void initComponents() {
        ...
        jtStudentData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Batch id", "Course", "Fee paid", "Remarks", "Discount"
            }
        ) {
...
//               enterfee.requestFocus(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddRemark.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//               studentSem.setText(sd.getStudentSem());
             // studentList.add(sd);
               ...
               //System.out.println(sd);
                ...
                Logger.getLogger(AddRemark.class.getName()).log(Level.SEVERE, null, ex);
            }
          ...
          try {
               ...
               int registrationId=RegistrationDao.getRegistrationId(contactNo,st.getBatchId());
                String remark=RegistrationDao.getRemark(registrationId);
                int discount=RegistrationDao.getDiscount(registrationId);
               if(remark==null)
                   rows[3]="No Remarks added";
               else
                    rows[3]=remark;
               rows[4]=discount;
          } catch (SQLException ex) {
