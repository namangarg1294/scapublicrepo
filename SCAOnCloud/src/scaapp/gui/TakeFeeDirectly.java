 ...
 * @author Comp10
 */
public class TakeFeeDirectly extends javax.swing.JFrame {
    private final TakeFeeDirectly ens = this;
    /**
...
//        String start=sdf.format(awtStartDate.getDate());
    ...
    TakeFeeDirectly(EmployeeDetails ed) {
       this();
       this.ed=ed;
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Reg Amount");

        Amount.setEditable(false);
        Amount.setText("Rs.100");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(batches, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(lock, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void studentIdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_studentIdKeyPressed
        if (evt.getKeyCode()==KeyEvent.VK_ENTER){
         ...
         if(evt.getKeyCode()==KeyEvent.VK_ENTER){
          try {
               dialog.setLocationRelativeTo(TakeFeeDirectly.this);
...
startSet();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TakeFeeDirectly.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new TakeFeeDirectly().setVisible(true);
            }
        });
    }
