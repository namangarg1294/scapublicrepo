...
private static final Logger LOGGER = Logger.getLogger(ChangeStudentDetails.class.getName() );
FileHandler fh;  
    ...
    try {  
        ...
        Logger.getLogger(ChangeStudentDetails.class.getName()).log(Level.SEVERE, null, ex);
